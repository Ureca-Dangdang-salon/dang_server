...
class NotificationControllerTest {
    ...
    void registerFcmToken() throws Exception {
        ...
        verify(notificationService, times(1)).saveOrUpdateFcmToken(anyLong(), eq(requestDto.getFcmToken()));
    }
    ...
    void getUnreadNotificationCount() throws Exception {
        ...
        when(redisNotificationService.getUnreadNotificationCount(anyLong())).thenReturn(5L);

        mockMvc.perform(get("/api/notification/unread-count").with(csrf()))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.response").value(5L));

        verify(redisNotificationService, times(1)).getUnreadNotificationCount(anyLong());
    }
    ...
    void getNotificationList() throws Exception {
        ...
        when(redisNotificationService.getNotificationList(anyLong())).thenReturn(List.of(notification1, notification2));
        ...
        verify(redisNotificationService, times(1)).getNotificationList(anyLong());
    }
    ...
    void updateNotificationAsRead() throws Exception {
        ...
        verify(redisNotificationService, times(1)).updateNotificationAsRead(anyLong(), eq("test-uuid"));
    }
    ...
    void markAllNotificationsAsRead() throws Exception {
        ...
        verify(redisNotificationService, times(1)).notificationsAsRead(anyLong());
    }
    ...
    void subscribeToTopic() throws Exception {
        ...
        verify(notificationService, times(1)).saveOrUpdateFcmToken(anyLong(), eq(requestDto.getFcmToken()));
        verify(notificationTopicService, times(1)).subscribeToTopic(eq(requestDto.getFcmToken()), eq(requestDto.getTopic()));
    }
    ...
    void unsubscribeFromTopic() throws Exception {
        ...
        verify(notificationTopicService, times(1)).unsubscribeFromTopic(eq(requestDto.getFcmToken()), eq(requestDto.getTopic()));
    }
    ...
    void updateUserNotification() throws Exception {
        ...
        verify(notificationService, times(1)).updateUserNotification(anyLong(), eq(true));
    }
}
