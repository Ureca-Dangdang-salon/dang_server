...
public class EstimateRequestProfiles extends BaseEntity {
    ...
    @Builder
    public EstimateRequestProfiles(EstimateRequest estimateRequest, DogProfile dogProfile, String currentImageKey, String styleRefImageKey, boolean aggression, boolean healthIssue, String description) {
