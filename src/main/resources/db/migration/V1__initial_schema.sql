...
CREATE TABLE `contest` (
  ...
  CONSTRAINT `FKpep7f3ti8l80x8uq6k1c85sfl` FOREIGN KEY (`winner_post_id`) REFERENCES `contest_post` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `contest_post` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UKbsfwrhxf307m1gu035atw3adk` (`contest_id`,`user_id`),
  KEY `FKp0ahhbideeq4wl0j71k0w9qey` (`groomer_profile_id`),
  KEY `FKsruxnbgdbee6l78bxnxejmtdx` (`user_id`),
  CONSTRAINT `FKgs14lxptpb7hbcrwabhug9jk6` FOREIGN KEY (`contest_id`) REFERENCES `contest` (`id`),
  CONSTRAINT `FKp0ahhbideeq4wl0j71k0w9qey` FOREIGN KEY (`groomer_profile_id`) REFERENCES `groomer_profile` (`id`),
  CONSTRAINT `FKsruxnbgdbee6l78bxnxejmtdx` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `district_service` (
  ...
  CONSTRAINT `FKnyllignrxg8cu6582avprepnt` FOREIGN KEY (`profile_id`) REFERENCES `groomer_profile` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `estimate_request` (
  ...
  `request_status` enum('CANCEL','COMPLETED','PAID','PENDING') DEFAULT NULL,
